        ...
        if ($inv = $this->pay_model->getSaleByID($id)) {
            ...
            if ($paypal->active && (($inv->grand_total - $inv->paid) > 0)) {
                ...
                $data = [
                    ...
                    'business'      => (DEMO ? 'pay@blackpunk.id' : $paypal->account_email),
        ...
        if (!$fp) {
            ...
            while (!feof($fp)) {
                ...
                if (stripos($res, 'VERIFIED') !== false) {
                    ...
                    if (($_POST['payment_status'] == 'Completed' || $_POST['payment_status'] == 'Processed' || $_POST['payment_status'] == 'Pending') && ($_POST['business'] == $paypal->account_email || $_POST['business'] == 'pay@blackpunk.id')) {
